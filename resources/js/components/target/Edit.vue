<template>
  ...
  <modal name="TargetModal" transition="fadeIn" @closed="cancelHandler" @opened="openedHandler">
        <div class="card">
            ...
            <div class="card-body">
                <form>                    
                    <div class="form-group">
                        ...
                        <small id="nameHelp" class="form-text text-muted">Наименование цели полета</small>
                    </div>
                </form>
...
export default{
    ...
    computed:{
        cardName() {return this.initialName.trim() == '' ? 'Новая цель' : 'Корректировка цели'},
        returnObject() {return {
            name: this.localName,
            id: this.id
        }},
